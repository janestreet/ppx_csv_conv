(* OASIS_START *)
(* DO NOT EDIT (digest: 45c8b4d650202a81f3ec95e1e2e41191) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_csv_conv";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "8y\237e*@G\000\140^\219\018\155\243,\006";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
